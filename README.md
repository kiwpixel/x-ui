...
```
bash <(curl -Ls https://raw.githubusercontent.com/kiwpixel/x-ui/master/install.sh)
```    
For English Users,please use the following command to install English supported version:  
```
bash <(curl -Ls https://raw.githubusercontent.com/kiwpixel/x-ui/master/install_en.sh)
